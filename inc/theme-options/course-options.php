...
function twentyeleven_customize_preview_js() {
  wp_enqueue_script( 'courses-customizer', get_template_directory_uri() . '/inc/theme-options/theme-instant-preview-options.js', array( 'customize-preview' ), '20121118', true );
}
