...
function _s_theme_options_init() {
	...
	add_settings_field( 'responsive_check', __('Is Responsive?', '_s'), '_s_settings_field_responsive_check', 'theme_options', 'general' );
 ...
 * Renders the sample checkbox setting field.
 */
function _s_settings_field_responsive_check() {
	$options = _s_get_theme_options();
	?>
	<label for="responsive-check">
		<input type="checkbox" name="_s_theme_options[responsive_check]" id="responsive-check" <?php checked( 'on', $options['responsive_check'] ); ?> />
		<?php _e( 'Yes!', '_s' ); ?>
	</label>
	<?php
}
...
function _s_theme_options_validate( $input ) {
	...
	if ( isset( $input['responsive_check'] ) )
		$output['responsive_check'] = 'on';
